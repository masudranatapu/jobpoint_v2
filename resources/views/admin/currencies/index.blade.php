            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatableWithPaginationPagination"
                        ...
                        <tbody>
                            <tr>
                                <td><span class="h5 text-inherit">Dollar</span></td>
                                <td>$</td>
                                <td>USD</td>
                                <td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Pound</span></td>
                                <td>£</td>
                                <td>GBP</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Euro</span></td>
                                <td>€</td>
                                <td>EUR</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Taka</span></td>
                                <td>৳</td>
                                <td>BDT</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Rupee</span></td>
                                <td>₹</td>
                                <td>INR</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
