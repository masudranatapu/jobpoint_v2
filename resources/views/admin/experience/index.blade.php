            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatableWithPaginationPagination"
                        ...
                        <tbody>
                            <tr>
                                <td><span class="h5 text-inherit">Beginner</span></td>
                                <td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Intermediate</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Advanced</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">0-1 Years</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">1-3 Years</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
