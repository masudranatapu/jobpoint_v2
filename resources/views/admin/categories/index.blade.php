            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#inviteUserModal">
                        <i class="bi-building me-1"></i> Create Category
                    </a>
                </div>
                <!-- End Col -->
            </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatableWithPaginationPagination"
                        ...
                        <tbody>
                            <tr>
                                <td><span class="h5 text-inherit">Engineering</span></td>
                                <td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Technology</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Sales</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Marketing</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Design</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
