            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#inviteUserModal">
                        <i class="bi-building me-1"></i> Create Designation
                    </a>
                </div>
                <!-- End Col -->
            </div>
            ...
            <div class="card">
                    ...
                    <div class="row justify-content-between align-items-center flex-grow-1">
                        <div class="col-12 col-md">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-header-title">Department Lists</h5>
                            </div>
                        </div>
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatableWithPaginationPagination"
                        ...
                        <tbody>
                            <tr>
                                <td><span class="h5 text-inherit">Chief Financial Officer</span></td>
                                <td>Finance</td>
                                <td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Chief Human Resources Officer</span></td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Chief Marketing Officer</span></td>
                                <td>Sales</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Sales Marketing Officer</span></td>
                                <td>Sales</td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
