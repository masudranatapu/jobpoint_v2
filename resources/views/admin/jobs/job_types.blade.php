            ...
            <div class="card">
                ...
                <div class="table-responsive datatable-custom">
                   ...
                   "pagination": "datatableWithPaginationPagination"
                        ...
                        <tbody>
                            <tr>
                                <td><span class="h5 text-inherit">Full-time</span></td>
                                <td>
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Part-time</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Temporary</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Remote</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td><span class="h5 text-inherit">Internship</span></td>
                                <td>
                                    <a href="/./admin/organizations/1/edit/index.html" class="btn btn-white btn-sm"><i
                                            class="bi-pencil-fill me-1"></i> Edit</a>
                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal"
