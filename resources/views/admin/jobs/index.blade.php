...
<div class="table-responsive datatable-custom">
  <table id="datatableColumnSearch" class="js-datatable table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
    ...
    <tr>
      <th>
        <input type="text" id="column1_search" class="form-control form-control-sm" placeholder="Search job title">
      </th>
      <th>
        <input type="text" id="column2_search" class="form-control form-control-sm" placeholder="Search organization">
      </th>
      <th>
        <input type="text" id="column3_search" class="form-control form-control-sm" placeholder="Search location">
      </th>
      <th>
        <input type="text" id="column4_search" class="form-control form-control-sm" placeholder="Search start date">
      </th>
      <th>
        <input type="text" id="column5_search" class="form-control form-control-sm" placeholder="Search end date">
      </th>      
      <th>
