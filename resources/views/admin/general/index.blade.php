    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">General</h1>
          </div>
          <!-- End Col -->
      ...
      <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form>
                  <!-- Form -->
                  <div class="row mb-4">
                    <label for="ApplicationNameLabel" class="col-sm-3 col-form-label form-label">Application Name</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="applicationname" id="ApplicationNameLabel" placeholder="Enter application name" aria-label="Enter application name" value="Bangali Technologies">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                   ...
                   <label for="LogoUploader" class="col-sm-3 col-form-label form-label">Logo</label>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <label for="LogoUploader">
                        <img class="img-fluid img-thumbnail" id="avatarImg" src="https://www.bangalistatic.com/images/logo.svg" alt="Image Description">
                      </label>

                      <div class="d-flex gap-3 ms-4">
                        <div class="form-attachment-btn btn btn-sm btn-primary">Upload photo
                          <input type="file" class="js-file-attach form-attachment-btn-label" id="LogoUploader"
                                 data-hs-file-attach-options='{
                                    "textTarget": "#avatarImg",
                                    "mode": "image",
                                    "targetAttr": "src",
                                    "resetTarget": ".js-file-attach-reset-img",
                                    "resetImg": "https://www.bangalistatic.com/images/logo.svg",
                                    "allowTypes": [".png", ".jpeg", ".svg", ".jpg"]
                                 }'>
                        </div>
                        <!-- End Avatar -->
                  ...
                  <div class="row mb-4">
                   ...
                   <label for="FaviconUploader" class="col-sm-3 col-form-label form-label">Favicon</label>
                    ...
                    <div class="d-flex align-items-center">
                      <!-- Avatar -->
                      <label for="FaviconUploader">
                        <img class="img-fluid img-thumbnail" id="faviconIco" src="https://www.bangalistatic.com/images/favicon.ico" alt="Image Description">
                      </label>

                      <div class="d-flex gap-3 ms-4">
                        <div class="form-attachment-btn btn btn-sm btn-primary">Upload photo
                          <input type="file" class="js-file-attach form-attachment-btn-label" id="FaviconUploader"
                                 data-hs-file-attach-options='{
                                    "textTarget": "#faviconIco",
                                    "mode": "image",
                                    "targetAttr": "src",
                                    "resetTarget": ".js-file-attach-reset-img",
                                    "resetImg": "https://www.bangalistatic.com/images/favicon.ico",
                                    "allowTypes": [".png", ".jpeg", ".ico", ".jpg"]
                                 }'>
                        </div>
                        <!-- End Avatar -->
                  ...
                  <!-- Form -->
                  <div class="row mb-4">
                    <label for="copyrightLabel" class="col-sm-3 col-form-label form-label">Copyright</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="copyright" id="copyrightLabel" placeholder="Your copyright" aria-label="Your copyright" value="© 2022 Bangali Technologies Limited. All rights reserved.">
                    </div>
                  </div>
                  <!-- End Form -->
            ...
            <!-- Card -->
            <div id="emailSection" class="card mt-7">
              <div class="card-header">
                <h2 class="card-title h4">Basic information</h2>
              </div>
